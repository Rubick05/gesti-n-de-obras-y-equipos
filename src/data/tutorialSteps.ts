...
export const TUTORIALS: TutorialDefinition[] = [
  ...
  // ── 4. Inventario en Bodega ───────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      {
        target: '#inventory-tab-loans',
        title: 'Gestión de Préstamos',
        description: 'Desde la pestaña "Préstamos" puedes registrar cuando una herramienta sale de bodega y asignarla a un trabajador y proyecto.',
        position: 'bottom',
        navigateTo: 'inventory',
        actionHint: 'Haz clic en la pestaña "Préstamos"',
      },
      {
        target: '#btn-checkout-tool',
        title: 'Registrar Préstamo',
        description: 'Al hacer clic en "Prestar" en una herramienta disponible, selecciona el trabajador, el proyecto y la fecha de devolución esperada.',
        position: 'left',
        navigateTo: 'inventory',
      },
      {
  ...
  // ── 5. Presupuesto y Gastos ───────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      {
        target: '#budget-project-selector',
        title: 'Seleccionar Proyecto',
        description: 'Primero selecciona el proyecto al que deseas agregar o revisar gastos. Verás el presupuesto total y el porcentaje consumido.',
        position: 'bottom',
        navigateTo: 'budget',
        actionHint: 'Selecciona un proyecto del menú desplegable',
      },
      {
  ...
  // ── 6. Gestión de Usuarios ────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Aquí verás todos los usuarios del sistema con su nombre, correo, rol (Administrador / Trabajador) y el trabajador vinculado en caso de ser trabajador.',
        position: 'bottom',
        navigateTo: 'users',
      },
      {
        target: '#users-role-badge',
        title: 'Roles del Sistema',
        description: 'Existen dos roles: **Administrador** (acceso total) y **Trabajador** (acceso solo al portal del trabajador con sus tareas y herramientas asignadas).',
        position: 'top',
        navigateTo: 'users',
      },
      {
